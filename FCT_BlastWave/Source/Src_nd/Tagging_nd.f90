...
subroutine state_error(tag,tag_lo,tag_hi, &
                       ...
                       maxgradpx,maxgradpy,tagfrac) bind(C, name="state_error")
  ...
  integer          :: lo(3),hi(3),comp_lo,comp_hi
  ...
  real(amrex_real) :: problo(3), dx(3), time, maxgradpx, maxgradpy, tagfrac
  integer          :: set,clear

  integer          :: i, j, k, rank
  real(amrex_real) :: dro, xcm, ycm, mid(2), gradpx, gradpy
