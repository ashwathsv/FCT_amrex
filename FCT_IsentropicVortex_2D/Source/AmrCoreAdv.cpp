...
AmrCoreAdv::AmrCoreAdv ()
{
    ...
    for (int n = 0; n < ncomp; ++n){
        ...
        // for (int dir = 0; dir <= 1; ++dir){
        //     bcs[ro].setLo(dir, BCType::reflect_even);
        //     bcs[ro].setHi(dir, BCType::reflect_even);

        //     bcs[roE].setLo(dir, BCType::reflect_even);
        //     bcs[roE].setHi(dir, BCType::reflect_even);

        //     bcs[pre].setLo(dir, BCType::reflect_even);
        //     bcs[pre].setHi(dir, BCType::reflect_even); 

        //     bcs[ent].setLo(dir, BCType::reflect_even);
        //     bcs[ent].setHi(dir, BCType::reflect_even);            
        // }
